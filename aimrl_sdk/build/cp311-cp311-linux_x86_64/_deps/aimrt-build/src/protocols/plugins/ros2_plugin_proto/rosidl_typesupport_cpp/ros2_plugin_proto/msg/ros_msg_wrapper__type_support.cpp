...
static const _RosMsgWrapper_type_support_symbol_names_t _RosMsgWrapper_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_plugin_proto, msg, RosMsgWrapper)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_plugin_proto, msg, RosMsgWrapper)),
  }
};
...
{
  return &::ros2_plugin_proto::msg::rosidl_typesupport_cpp::RosMsgWrapper_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_plugin_proto, msg, RosMsgWrapper)() {
  return get_message_type_support_handle<ros2_plugin_proto::msg::RosMsgWrapper>();
}
