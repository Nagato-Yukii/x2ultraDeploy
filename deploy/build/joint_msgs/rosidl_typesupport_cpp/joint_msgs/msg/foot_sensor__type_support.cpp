...
static const _FootSensor_type_support_symbol_names_t _FootSensor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, joint_msgs, msg, FootSensor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, joint_msgs, msg, FootSensor)),
  }
};
...
{
  return &::joint_msgs::msg::rosidl_typesupport_cpp::FootSensor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, joint_msgs, msg, FootSensor)() {
  return get_message_type_support_handle<joint_msgs::msg::FootSensor>();
}
