...
namespace protocols {
namespace sensor {
PROTOBUF_CONSTEXPR ImuState::ImuState(
...
struct ImuStateDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ImuStateDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~ImuStateDefaultTypeInternal() {}
  union {
    ImuState _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ImuStateDefaultTypeInternal _ImuState_default_instance_;
}  // namespace sensor
}  // namespace protocols
}  // namespace aimrt
...
const uint32_t TableStruct_imu_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::aimrt::protocols::sensor::ImuState, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::aimrt::protocols::sensor::ImuState, _impl_.header_),
  PROTOBUF_FIELD_OFFSET(::aimrt::protocols::sensor::ImuState, _impl_.orientation_),
  PROTOBUF_FIELD_OFFSET(::aimrt::protocols::sensor::ImuState, _impl_.orientation_covariance_),
  PROTOBUF_FIELD_OFFSET(::aimrt::protocols::sensor::ImuState, _impl_.angular_velocity_),
  PROTOBUF_FIELD_OFFSET(::aimrt::protocols::sensor::ImuState, _impl_.angular_velocity_covariance_),
  PROTOBUF_FIELD_OFFSET(::aimrt::protocols::sensor::ImuState, _impl_.linear_acceleration_),
  PROTOBUF_FIELD_OFFSET(::aimrt::protocols::sensor::ImuState, _impl_.linear_acceleration_covariance_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::aimrt::protocols::sensor::ImuState)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::aimrt::protocols::sensor::_ImuState_default_instance_._instance,
};

const char descriptor_table_protodef_imu_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\timu.proto\022\026aimrt.protocols.sensor\032\014hea"
  "der.proto\032\020quaternion.proto\032\rvector3.pro"
  "to\"\337\002\n\010ImuState\022.\n\006header\030\001 \001(\0132\036.aimrt."
  "protocols.common.Header\0229\n\013orientation\030\002"
  " \001(\0132$.aimrt.protocols.geometry.Quaterni"
  "on\022\036\n\026orientation_covariance\030\003 \003(\001\022;\n\020an"
  "gular_velocity\030\004 \001(\0132!.aimrt.protocols.g"
  "eometry.Vector3\022#\n\033angular_velocity_cova"
  "riance\030\005 \003(\001\022>\n\023linear_acceleration\030\006 \001("
  "\0132!.aimrt.protocols.geometry.Vector3\022&\n\036"
  "linear_acceleration_covariance\030\007 \003(\001b\006pr"
  "oto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_imu_2eproto = {
    false, false, 444, descriptor_table_protodef_imu_2eproto,
    "imu.proto",
...
class ImuState::_Internal {
 public:
  static const ::aimrt::protocols::common::Header& header(const ImuState* msg);
  static const ::aimrt::protocols::geometry::Quaternion& orientation(const ImuState* msg);
  static const ::aimrt::protocols::geometry::Vector3& angular_velocity(const ImuState* msg);
  static const ::aimrt::protocols::geometry::Vector3& linear_acceleration(const ImuState* msg);
};

const ::aimrt::protocols::common::Header&
ImuState::_Internal::header(const ImuState* msg) {
  return *msg->_impl_.header_;
}
const ::aimrt::protocols::geometry::Quaternion&
ImuState::_Internal::orientation(const ImuState* msg) {
  return *msg->_impl_.orientation_;
}
const ::aimrt::protocols::geometry::Vector3&
ImuState::_Internal::angular_velocity(const ImuState* msg) {
  return *msg->_impl_.angular_velocity_;
}
const ::aimrt::protocols::geometry::Vector3&
ImuState::_Internal::linear_acceleration(const ImuState* msg) {
  return *msg->_impl_.linear_acceleration_;
}
void ImuState::clear_header() {
  if (GetArenaForAllocation() == nullptr && _impl_.header_ != nullptr) {
    delete _impl_.header_;
  }
  _impl_.header_ = nullptr;
}
void ImuState::clear_orientation() {
  if (GetArenaForAllocation() == nullptr && _impl_.orientation_ != nullptr) {
    delete _impl_.orientation_;
  }
  _impl_.orientation_ = nullptr;
}
void ImuState::clear_angular_velocity() {
...
void ImuState::clear_linear_acceleration() {
...
ImuState::ImuState(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:aimrt.protocols.sensor.ImuState)
}
...
inline void ImuState::SharedCtor(
...
ImuState::~ImuState() {
  // @@protoc_insertion_point(destructor:aimrt.protocols.sensor.ImuState)
...
inline void ImuState::SharedDtor() {
...
void ImuState::Clear() {
// @@protoc_insertion_point(message_clear_start:aimrt.protocols.sensor.ImuState)
...
const char* ImuState::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* ImuState::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:aimrt.protocols.sensor.ImuState)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:aimrt.protocols.sensor.ImuState)
  return target;
}
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ImuState::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    ImuState::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ImuState::GetClassData() const { return &_class_data_; }
...
// @@protoc_insertion_point(class_specific_copy_from_start:aimrt.protocols.sensor.ImuState)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void ImuState::InternalSwap(ImuState* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ImuState, _impl_.linear_acceleration_)
      + sizeof(ImuState::_impl_.linear_acceleration_)
      - PROTOBUF_FIELD_OFFSET(ImuState, _impl_.header_)>(
...
template<> PROTOBUF_NOINLINE ::aimrt::protocols::sensor::ImuState*
Arena::CreateMaybeMessage< ::aimrt::protocols::sensor::ImuState >(Arena* arena) {
  return Arena::CreateMessageInternal< ::aimrt::protocols::sensor::ImuState >(arena);
}
