...
const uint32_t TableStruct_error_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::aimrt::protocols::common::Error, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::aimrt::protocols::common::Error, _impl_.code_),
  PROTOBUF_FIELD_OFFSET(::aimrt::protocols::common::Error, _impl_.msg_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::aimrt::protocols::common::Error)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::aimrt::protocols::common::_Error_default_instance_._instance,
};

const char descriptor_table_protodef_error_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013error.proto\022\026aimrt.protocols.common\"\"\n"
...
const ::_pbi::DescriptorTable descriptor_table_error_2eproto = {
    false, false, 81, descriptor_table_protodef_error_2eproto,
    "error.proto",
...
Error::Error(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:aimrt.protocols.common.Error)
}
Error::Error(const Error& from)
  ...
  // @@protoc_insertion_point(copy_constructor:aimrt.protocols.common.Error)
}
...
Error::~Error() {
  // @@protoc_insertion_point(destructor:aimrt.protocols.common.Error)
...
void Error::Clear() {
// @@protoc_insertion_point(message_clear_start:aimrt.protocols.common.Error)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "aimrt.protocols.common.Error.msg"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* Error::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:aimrt.protocols.common.Error)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_msg().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "aimrt.protocols.common.Error.msg");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:aimrt.protocols.common.Error)
  return target;
}

size_t Error::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:aimrt.protocols.common.Error)
  size_t total_size = 0;
...
void Error::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:aimrt.protocols.common.Error)
...
// @@protoc_insertion_point(class_specific_copy_from_start:aimrt.protocols.common.Error)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::aimrt::protocols::common::Error*
Arena::CreateMaybeMessage< ::aimrt::protocols::common::Error >(Arena* arena) {
  return Arena::CreateMessageInternal< ::aimrt::protocols::common::Error >(arena);
}
