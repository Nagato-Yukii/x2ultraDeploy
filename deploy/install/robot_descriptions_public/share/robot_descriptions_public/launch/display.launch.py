...
def generate_launch_description():
    urdf_arg = DeclareLaunchArgument(name='urdf', default_value='x2_ultra.urdf', choices=['model.urdf', 'model_with_finger.urdf','x2_ultra.urdf',], description='Name of the urdf file')
