...
static const _JointState_type_support_symbol_names_t _JointState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aimrt_msgs, msg, JointState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aimrt_msgs, msg, JointState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aimrt_msgs, msg, JointState)() {
  return &::aimrt_msgs::msg::rosidl_typesupport_c::JointState_message_type_support_handle;
}
